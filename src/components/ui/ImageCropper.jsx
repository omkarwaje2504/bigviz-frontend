      ...
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 flex flex-wrap gap-4 justify-between items-center">
        <div className="flex flex-wrap gap-1">
          ...
          <button
            type="button"
            onClick={onRemove}
            className="bg-red-500 hover:bg-red-600 p-2 rounded-lg text-white md:hidden transition"
            title="Remove Image"
          ...
          <button
            ...
            className="bg-red-700 ml-6 hover:bg-red-600 p-2 rounded-lg text-white transition"
            title="Disable Image"
        ...
        <div className="gap-3 hidden md:flex">
          ...
          <button
            type="button"
            onClick={() => setUnsavedChanges(false)}
            className="bg-red-500 hover:bg-red-600 ml-6 p-2 rounded-lg text-white transition"
            title="Disable Image"
            aria-label="Disable image"
          >
            <IoClose size={20} />
        ...
        {editMode === "crop" ? (
          ...
          image?.src && (
            <img
              ...
              src={image.src}
              alt="Preview"
              className="max-h-[50%] transition-all duration-200"
